...
//		if (root == null) return null; // empty tree
	...
	public String inOrderToString() {
		...
		inOrderToString(root, strbld);
		return strbld.toString();
	}
	
	private void inOrderToString(TNode<T> curr, StringBuilder strbld) {
		if (curr == null) return;
		inOrderToString(curr.getLeft(), strbld);
		strbld.append(curr + " - ");
		inOrderToString(curr.getRight(), strbld);
	}
